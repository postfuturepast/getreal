...
- Tables: property_sales (NSW individual records), suburb_analytics (VIC + NSW aggregates), price_curves (NSW-derived distribution curves)
...
## Pending work
- Task #42: Discuss adding target ring visual to web page
- Task #44: Add static map image to PDF report
- Task #45: Embed live price_curves table in FAQ VIC methodology entry
- Task #48: Document/automate data refresh pipeline
